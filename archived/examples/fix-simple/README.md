...
```shell
$ kpt pkg get https://github.com/kptdev/krm-functions-catalog/tree/master/archived/examples/fix-simple
```
...
```shell
$ kpt fn eval fix-simple --image ghcr.io/kptdev/krm-functions-catalog/archived/fix:latest --include-meta-resources
```
