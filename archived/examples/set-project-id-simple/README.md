...
```shell
kpt pkg get https://github.com/kptdev/krm-functions-catalog.git/archived/examples/set-project-id-simple
```
...
```shell
kpt fn eval set-project-id-simple --image ghcr.io/kptdev/krm-functions-catalog/archived/set-project-id:latest -- 'project-id=foo'
```
