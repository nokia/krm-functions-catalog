...
```shell
$ kpt pkg get https://github.com/kptdev/krm-functions-catalog.git/archived/examples/export-terraform-imperative
```
...
```shell
$ kpt fn eval export-terraform-imperative --image ghcr.io/kptdev/krm-functions-catalog/archived/export-terraform:latest
```
