...
# decrypt
kpt fn eval --fn-config decrypt.yaml --env SOPS_IMPORT_PGP="$(cat pgp_keys.txt)" \
	--include-meta-resources \
	--image-pull-policy never --image ghcr.io/kptdev/krm-functions-catalog/archived/sops:latest
