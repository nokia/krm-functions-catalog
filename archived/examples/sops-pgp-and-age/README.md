...
```shell
$ kpt pkg get https://github.com/kptdev/krm-functions-catalog.git/archived/examples/sops-pgp-and-age
```
...
$ kpt fn eval \
        ...
        --image ghcr.io/kptdev/krm-functions-catalog/archived/sops:latest \
...
Please find the `sops` KRM config function description [here](/archived/functions/ts/sops/README.md)
