...
var AnnotateApplyTimeMutationsShort = `The ` + "`" + `annotate-apply-time-mutations` + "`" + ` function enables authors to use alternate
...
those annotations.`
var AnnotateApplyTimeMutationsLong = `
## Usage
...
`
var AnnotateApplyTimeMutationsExamples = `
