...
```shell
$ kpt fn eval --image ghcr.io/kptdev/krm-functions-catalog/starlark:v0.4.3 -- source="$(cat main.star)" param1=value1 param2=value2
```
...
```shell
$ kpt fn eval --image ghcr.io/kptdev/krm-functions-catalog/starlark:v0.4.3 --fn-config fn-config.yaml
```
